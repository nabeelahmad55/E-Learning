...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2025 at 07:18 PM
...
(1, 'F-12345', 1, 'George', 'C', 'Wilson', 'gwilson@sample.com', '+1234567899', 'Male', 'Sample Address', '1', '2022-08-22', 'uploads/1668882660_faculty.png');

-- --------------------------------------------------------

--
-- Table structure for table `faculty_student_relationship`
--

CREATE TABLE `faculty_student_relationship` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `faculty_student_relationship`
--

INSERT INTO `faculty_student_relationship` (`id`, `student_id`, `faculty_id`, `date_created`) VALUES
(2, 13, 1, '2024-12-20 09:27:38');
...
INSERT INTO `otp_verification` (`id`, `email`, `otp`, `expiry`, `created_at`) VALUES
(39, 'nab.ahmad55@gmail.com', '399258', '2024-12-20 21:12:59', '2024-12-20 16:11:59'),
(40, 'nab.ahmad55@gmail.com', '113843', '2024-12-20 21:16:13', '2024-12-20 16:15:13'),
(41, 'nab.ahmad55@gmail.com', '968730', '2024-12-25 17:10:30', '2024-12-25 09:05:30'),
(42, 'nab.ahmad55@gmail.com', '355223', '2024-12-25 17:39:43', '2024-12-25 09:34:43'),
(43, 'azizrasool248@gmail.com', '434323', '2024-12-25 18:11:21', '2024-12-25 10:06:21'),
(44, 'nab.ahmad55@gmail.com', '583478', '2024-12-28 00:58:01', '2024-12-27 16:53:01');
...
(12, '4', 'ds', 'ew', 'sd', 'a', 'ds', 'ds', 'sd', '1', NULL, NULL),
(13, '1', 'as', 'sa', 'sa', '23', 'as', 'sa', 'sa', '$2y$10$jktu6v/cBja4iqBJPwq81eD/FN12C8SFF9o6rmeObwjI1omfrcXIi', NULL, NULL),
(14, '420', 'umair', 'main', 'akhtar', 'umairakhtar695@gmail.com', '65', 'sa', 'asz', '$2y$10$k6GG1wzKkR2WhH78nXOOZ.nYTv1P5EYHayNUxTTxpch/MckmL0EGG', NULL, NULL),
(15, '65', 'as', 'sa', 'as', '1', '65', 'sd', 'sd', '$2y$10$xylu5.hPjXilPmwXerT/eO7e1YnofzA2GdvoLakKofa/7RGl.Dbw.', NULL, NULL),
(16, 'ds', 'sd', 'ds', 'sd', '1', '65', 'ds', 'ds', '$2y$10$QPhyZ6pc9wn2M7FHGV/ayORLBBupSjx6Ho5F1s9/IHGehmgiqos7O', NULL, NULL),
(17, '5', 'nabeel', 'ahmad', 'ahmad', '4', '+92 3160170546', 'male', '58', '56', NULL, NULL),
(18, '8', 'fsd', 'sd', 'sd', '54', '56', 'sd', 'sfd', '$2y$10$WjIHj2I1liy6GC8sDNGQGuRg5acJE25jGPVNXMGjE5oClAi8HBMHa', NULL, NULL),
(19, '654', 'aziz', 'bhai', 'ahmad', 'azizrasool248@gmail.com', '65', 'Male', 'ac', '$2y$10$43VWVdOZwVSSW3sPGULJH.FBoS3nPCT1FTLg.nW0sUN0uCotguM6G', NULL, NULL),
(20, '277578', 'Nabeel', 'ad', 'ahamd', 'nab.ahmad55@gmail.com', 'ds', 'ds', 'sd', '$2y$10$F35bDaUAr32agiK.qt4BBO5AJ7QZm6Ygks23hosfZPnCJpWw1eKuO', NULL, NULL);
...
(8, 'Screen Recording 2024-12-20 174855.mp4', 'uploads/media/1/Screen Recording 2024-12-20 174855.mp4', 1, '2024-12-27 21:50:31');
...
--
-- Indexes for table `faculty_student_relationship`
--
ALTER TABLE `faculty_student_relationship`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `faculty_student_relationship`
--
ALTER TABLE `faculty_student_relationship`
...
--
-- Constraints for table `faculty_student_relationship`
--
ALTER TABLE `faculty_student_relationship`
  ADD CONSTRAINT `faculty_student_relationship_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  ADD CONSTRAINT `faculty_student_relationship_ibfk_2` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`id`);
COMMIT;
